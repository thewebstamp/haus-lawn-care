    ...
    return (
        <div className="reachout-comp">
            <div className="r-top" ref={reachoutT}>
                ...
                <p>Whether you need dependable <b>weekly mowing, seasonal cleanup, landscape design, privacy fencing, or emergency snow removal</b>, we’re here to help — fast, local, and ready when you are.</p>
